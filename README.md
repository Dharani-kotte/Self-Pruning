...
> **Tip**: Use [Google Colab](https://colab.research.google.com) (free GPU) to run faster.
...
> Actual numbers are printed by the script after training.

---

## Key Files Explained

### `PrunableLinear` (in `self_pruning_network.py`)
...
## Why L1 Encourages Sparsity (Short Answer)
...
See `results_table.md` for the full mathematical explanation.
